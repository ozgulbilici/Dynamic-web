                 ...
                 <form class="" action="" method="post" enctype="multipart/form-data">
                      ...
                      <br>
                        ...
                        <div style="padding-bottom: 10px;"> <span id="card-inner">Country</span> 
                                ...
                                <div class="custom-select" style="width:200px;">
                                      <select>
                                        ...
                                        <option value="5">Çanakkale</option>
                            ...
                            <form id="ifYes" style="display: none;" onsubmit="return false"> <span id="card-header"></span>
                                            <div>
                                                <div class="col-2" style="padding-bottom: 15px; padding-top: 10px">
                                                    <span id="card-inner">Card Information</span> 
                                                </div>
                                                <div class="row">
                                                	<div class="col-2">
                                            ...
                                            <div class="row three">
                                                ...
                                                <div class="col-2" style="float: right"> <input type="text" placeholder="Card Date"><input type="text" placeholder="CVV"> </div> 
                                            </div>
                                            </div>
                                        </form>
                                        <br>
                        ...
                        <div class="form-group">
                          ...
                          <div class="row">
                            <div class="col-2">
                              <button class = "btn" type="button" style="text-align:center;" >Purchase</button>
                            </div>
                          </div>
                        </div>
                      </div>
